...
from flash_attn.cute.nsa.nsa_interface import _nsa_slc_fwd
...
def test_helper(bsz, seqlen_q, seqlen_k, head_q, head_k, dim):
    ...
    fwd_func_128x128x384 = partial(_nsa_slc_fwd, q, k, v, cu_seqlens_q, cu_seqlens_k, causal=True)
    fwd_func_128x64x384  = partial(_nsa_slc_fwd, q, k, v, cu_seqlens_q, cu_seqlens_k, causal=True, m_block_size=128, n_block_size=64, num_threads=384)
    fwd_func_64x64x256   = partial(_nsa_slc_fwd, q, k, v, cu_seqlens_q, cu_seqlens_k, causal=True, m_block_size=64, n_block_size=64, num_threads=256)
